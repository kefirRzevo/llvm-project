//===-- RISCSISAInfo.h - RISC-S ISA Information -----------------*- C++ -*-===//
//
...
class RISCSISAInfo {
public:
  RISCSISAInfo(const RISCSISAInfo &) = delete;
  RISCSISAInfo &operator=(const RISCSISAInfo &) = delete;
  ...
  RISCSISAInfo(unsigned XLen, OrderedExtensionMap &Exts)
  ...
  static llvm::Expected<std::unique_ptr<RISCSISAInfo>>
  ...
  static llvm::Expected<std::unique_ptr<RISCSISAInfo>>
  postProcessAndChecking(std::unique_ptr<RISCSISAInfo> &&ISAInfo);
  static std::string getTargetFeatureForExtension(StringRef Ext);

private:
  RISCSISAInfo(unsigned XLen)
