//===-- RISCSAttributes.cpp - RISCS Attributes ----------------------------===//
//
...
using namespace llvm::RISCSAttrs;
...
constexpr TagNameMap RISCSAttributeTags{TagData};
const TagNameMap &llvm::RISCSAttrs::getRISCSAttributeTags() {
  return RISCSAttributeTags;
}
