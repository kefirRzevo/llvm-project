...
// RISC-S Specific Machine Operand Flags
enum {
  MO_None = 0,
  MO_CALL = 1,
  MO_PLT = 2,
...
} // end namespace riscsCC

namespace riscsOp {
enum OperandType : unsigned {
  OPERAND_FIRST_riscs_IMM = MCOI::OPERAND_FIRST_TARGET,
  // OPERAND_UIMM2 = OPERAND_FIRST_riscs_IMM,
  // OPERAND_UIMM3,
  // OPERAND_UIMM4,
  // OPERAND_UIMM5,
  // OPERAND_UIMM7,
  ...
  OPERAND_RVKRNUM,
  OPERAND_LAST_riscs_IMM = OPERAND_RVKRNUM,
...
#endif // __LLVM_LIB_TARGET_RISCS_MCTARGETDESC_RISCSINFO_H__
