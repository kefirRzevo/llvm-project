//===-- RISCSELFStreamer.h - RISCS ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_RISCS_MCTARGETDESC_RISCSELFSTREAMER_H
#define LLVM_LIB_TARGET_RISCS_MCTARGETDESC_RISCSELFSTREAMER_H
...
class RISCSTargetELFStreamer : public RISCSTargetStreamer {
private:
...
public:
  ...
  RISCSTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
