...
#include "RISCSGenAsmWriter.inc"

void RISCSInstPrinter::printRegName(raw_ostream &O, MCRegister Reg) {
...
const char *RISCSInstPrinter::getRegisterName(MCRegister Reg) {
  return getRegisterName(Reg, riscs::NoRegAltName);
}
